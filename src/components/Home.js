...
render(){
    ...
    */}
<img src = 'https://github.com/jokessenich/corky/blob/master/Prodigious%20Son%20BOOK%203D.jpg?raw=true' height='450' width = '300' />
        

        <div className="infoBox">
            <h3>"CORKY" is an honest and insightful look into a life well-lived and filled with colorful tales of a time though recent yet forgotten but to those of us who lived through it .
</h3>
<h4>-Jack Bornoff</h4>
<br />
<h3>There is a tangible love felt in these pages, for every character we encounter. Every single one. Even in his depictions of heartbreak or cruelty, Matson generously renders a world—and a philosophy—of hope, kindness, and perseverance. Never have I had the pleasure of reading a memoir so thoughtful in its understanding of humanity, the preservation of memory, and a feeling of optimism that compels you to leave its pages rejuvenated and optimistic about what there is to come.</h3>
<h4>-Sarah Tierney</h4>
        ...
        <p>How many times can you cheat death on your path to
                ...
                as he struggles with his inner demons—and angels. Born to
